    ...
    <Card noPadding appearance='ghost' className='gap-4 flex flex-col'>
        ...
        <section className='grid grid-cols-12 gap-x-14'>
          ...
          <article className='col-span-7 gap-y-4 flex flex-col'>
            ...
            <div className="flex gap-x-2">
              <Button appearance="mate" label="Open" color='blue' intensity={800} icon={<FaArrowUpRightFromSquare/>} style={{color: 'white'}} onClick={fitnessAppPage}/>
              <Button appearance='ghost' label="Repo" color='blue' intensity={800} icon={<FaGithub/>} style={{color: '#17A7EE'}} onClick={fitnessAppRepo}/>
            </div>
          </article>
        </section>
      </Card>
      ...
      <section className='grid grid-cols-12 gap-x-4'>
        <Card appearance='mate' color="purple" intensity={500} className='col-span-6 rounded-xl gap-y-4 flex flex-col h-[22.25rem]'>
          ...
          <section className='grid grid-cols-12 gap-x-4'>
            <img color='purple' src='/library_preview.png' className='col-span-6 rounded-lg'/>
            <div className='col-span-6 flex flex-col gap-y-4'>
              ...
              <div className="flex gap-x-2">
              <Button label="Open" appearance='mate' color='purple' intensity={800} icon={<FaArrowUpRightFromSquare/>} style={{ color: 'white'}} onClick={libraryPage}/>
              <Button appearance='ghost' label="Repo" color='purple' intensity={800} icon={<FaGithub/>} style={{ color: '#9b8ce9'}} onClick={libraryRepo}/>
            </div>
            </div>
          </section>
        </Card>
