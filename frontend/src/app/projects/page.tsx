    ...
    <div className='grid gap-y-4'>
      ...
      <Card appearance='mate' color="blue" intensity={500} className='grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-x-8 items-center rounded-xl'>
        ...
        <Card appearance='ghost' className='flex flex-col gap-y-4 lg:col-span-5 min-w-0 justify-center'>
          <h2 style={{ color: 'var(--text-blue)'}} className='text-2xl! font-bold'>Golden·Core</h2>
          <p style={{ color: 'black'}}>
          ...
          <section className="flex gap-x-2">
            <Button appearance="mate" label="Open" color="blue" intensity={800} icon={<FaArrowUpRightFromSquare/>} onClick={goldenCoreAppPage}/>
      ...
      <Card appearance='mate' color="blue" intensity={500} className='grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-x-8 items-center rounded-xl'>
        ...
        <Card appearance='ghost' className='flex flex-col gap-y-4 lg:col-span-5 min-w-0 justify-center'>
          <h2 style={{ color: 'var(--text-blue)'}} className='text-2xl! font-bold'>Fitness App</h2>
          <p style={{ color: 'black'}}>
          ...
          <section className="flex gap-x-2">
            <Button appearance="mate" label="Open" color="blue" intensity={800} icon={<FaArrowUpRightFromSquare/>} onClick={fitnessAppPage}/>
      ...
      <Card appearance='mate' color="blue" intensity={500} className='grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-x-8 items-center rounded-xl'>
        ...
        <Card appearance='ghost' className='flex flex-col gap-y-4 lg:col-span-5 min-w-0 justify-center'>
          <h2 style={{ color: 'var(--text-blue)'}} className='text-2xl! font-bold'>Azeriand&apos;s Library</h2>
          <p style={{ color: 'black'}}>
          ...
          <section className="flex gap-x-2">
            <Button appearance="mate" label="Open" color="blue" intensity={800} icon={<FaArrowUpRightFromSquare/>} onClick={libraryPage}/>
      ...
      <Card appearance='mate' color="blue" intensity={500} className='grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-x-8 items-center rounded-xl'>
        ...
        <Card appearance='ghost' className='flex flex-col gap-y-4 lg:col-span-5 min-w-0 justify-center'>
          <h2 style={{ color: 'var(--text-blue)'}} className='text-2xl! font-bold'>Portfolio</h2>
          <p style={{ color: 'black'}}>
