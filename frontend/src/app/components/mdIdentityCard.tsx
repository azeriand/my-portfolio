  ...
  return (
    <Card noPadding appearance='mate' color='red' intensity={200} className='flex flex-row items-center justify-between gap-4 p-6 rounded-xl'>
      <section className='min-w-0'>
        <p style={{ color: '#f54c4a', textShadow: '0 1px 2px rgba(0,0,0,0.2)' }} className='text-2xl font-extrabold break-words'>Andrea Romera</p>
        <p style={{ color: '#fefefe', textShadow: '0 1px 2px rgba(0,0,0,0.2)' }} className='text-lg font-semibold'>Frontend Developer</p>
      </section>
